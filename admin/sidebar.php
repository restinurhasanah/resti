...
<div class="d-flex flex-column flex-shrink-0 p-3 bg-dark text-white position-fixed shadow-lg"
  ...
  <ul class="nav nav-pills flex-column mb-auto">
    ...
    <li class="nav-item">
      <a href="http://localhost/KasirWedanganNusantara/admin/kategori.php"
        class="nav-link text-white <? = $current_page == 'kategori.php' ? 'active bg-secondary' : ''; ?>">
        <i class="bi bi-bookmark-plus-fill"></i> kategori
      </a>
